...
def calc_loss(cur_series_covariate_tensor: torch.Tensor,
    ...
    next_covariate_tensor = next_covariate_tensor.permute(1, 0,
                                                          2)  # [seq_len, batch_size, covariate_size * horizon_size]
    ...
    hidden_and_covariate = torch.cat([enc_hs, next_covariate_tensor],
                                     dim=2)  # [seq_len, batch_size, hidden_size+covariate_size * horizon_size]
    ...
    local_decoder_input = torch.cat([gdecoder_output, next_covariate_tensor],
                                    dim=2)  # [seq_len, batch_size,(horizon_size+1)*context_size + covariate_size * horizon_size]
    ...
    local_decoder_output = local_decoder_output.view(seq_len, batch_size, horizon_size,
